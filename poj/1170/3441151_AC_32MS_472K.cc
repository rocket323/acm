				...
				for(a3=0; a3<=num[3]; a3++)
					for(a4=0; a4<=num[4]; a4++)
						for(a5=0; a5<=num[5]; a5++){
							f[a1][a2][a3][a4][a5]=p[1]*a1+p[2]*a2+p[3]*a3+p[4]*a4+p[5]*a5;
						}
	f[0][0][0][0][0]=0;
				...
				for(a3=sn[i][3]; a3<=num[3]; a3++)
					for(a4=sn[i][4]; a4<=num[4]; a4++)
						for(a5=sn[i][5]; a5<=num[5]; a5++){
							...
							x=f[a1-sn[i][1]][a2-sn[i][2]][a3-sn[i][3]][a4-sn[i][4]][a5-sn[i][5]];
							if(x+sp[i]<f[a1][a2][a3][a4][a5])
								f[a1][a2][a3][a4][a5]=x+sp[i];
							//x=f[a1][a2][a3][a4][a5]+(num[1]-a1)*p[1]+(num[2]-a2)*p[2]+(num[3]-a3)*p[3]+(num[4]-a4)*p[4]+(num[5]-a5)*p[5];
							//if(x<ans){
							//	ans=x;
							//}
						}

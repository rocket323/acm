...
{
	int flag = 0;
	if(p1.x == 1 && p1.y == 4 && p2.x == 4 && p2.y == 4) flag = 1;

	int d1 = cross(Point(p2.x-p1.x, p2.y-p1.y), Point(p3.x-p2.x, p3.y-p2.y));
	int d2 = cross(Point(p2.x-p1.x, p2.y-p1.y), Point(p4.x-p2.x, p4.y-p2.y));
	int d3 = cross(Point(p4.x-p3.x, p4.y-p3.y), Point(p1.x-p4.x, p1.y-p4.y));
	int d4 = cross(Point(p4.x-p3.x, p4.y-p3.y), Point(p2.x-p4.x, p2.y-p4.y));

...
public class Main {
	...
	public int go1()
	{
		...
		for(int i=0; i<m; ++i)
		{
			...
			for(int j=0; j<len[i]; ++j) System.out.print(a[i][j] + " ");
			System.out.println();

			for(int j=0; j<len[i]; ++j) System.out.print(b[i][j] + " ");
			System.out.println();
			...
			if(str[i].charAt(0) == '<')
			{
				...
				for(int j=0; j<n; ++j) ans[i] = ans[j] & tmp[j];
			}
...
//			System.out.println(a1 + " " + a2);
			...
			if(a1 != -1 && a2 == -1) System.out.println(a1);
			if(a1 == -1 && a1 != -1) System.out.println(a2);
			if(a1 != -1 && a2 != -1)
			{
				if(a1 == a2) System.out.println(0);

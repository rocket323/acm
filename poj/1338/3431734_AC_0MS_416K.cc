...
long long m,n;
long long len,ans[2000],v[4]={0,2,3,5};
long long xtmp[6],xt[6];
long long px[6];

void swap(long long s, long long t){
	long long tmp;
...
void insert(long long ele, long long rr){
	long long i,j,k;
	len++;
